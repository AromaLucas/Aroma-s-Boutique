...
<style type="text/css">
body {
  background: url('resources/images/reg.jpg') no-repeat center center fixed;
          ...
          <div class="card-body">
            ...
            <form class="form-signin" action="<c:url value= "/signup" />" method="post">
              ...
              <div class="form-label-group">
               ...
               <div class="form-label-group">
                <input type="text" id="address" class="form-control" name="Address_Line1" placeholder="Address_Line1" required autofocus>
